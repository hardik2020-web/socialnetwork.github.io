...
) ENGINE=MyISAM AUTO_INCREMENT=293 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;
...
(147, 'ftp_path', ''),
(148, 'ftp_endpoint', ''),
(149, 'session_hash', '5FmdaZtes-25mGb-4yYJB-42m7l-48IFK-84d291abf9cc'),
...
(216, 'forums_online_enabled', '0'),
(217, 'forums_statistics_enabled', '0'),
                ...
                <form id="myform" class="fs-form fs-form-full" autocomplete="off" action="install.php" method="post">
                    <ol class="fs-fields">
                        ...
                        <li>
                            ...
                            <input class="fs-anim-lower" id="purchase_code" name="purchase_code" value="<?php echo $key; ?>" type="text" required/>
                        </li>
